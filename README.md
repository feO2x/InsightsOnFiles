# InsightsOnFiles
Some performace tests for file-based operations on .NET Core

This repository contains triangulation and performance tests for FileStreams in .NET Core 2.2. Especially the performance comparison between asynchronous and synchronous streams is interesting, as the latter performs better than the async version across the board. 
